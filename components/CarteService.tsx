  ...
  return (
    <>
      ...
      <dialog
        ...
        className="m-auto w-[min(860px,94vw)] max-h-[92vh] p-0 rounded-[var(--radius-l)] border-0 bg-surface text-ink shadow-2xl backdrop:bg-[#0f1d2c]/70 backdrop:backdrop-blur-sm"
      >
        {ouverte ? (
          <div className="grid md:grid-cols-[1.15fr_1fr]">
            {/* ---------- Galerie ---------- */}
            <div className="bg-surface-2 p-4 flex flex-col gap-2.5">
                ...
                <div className="flex gap-2 overflow-x-auto pb-1">
                  {photos.map((src, i) => (
                    <button
                      ...
                      className={`relative w-16 h-12 shrink-0 rounded-md overflow-hidden cursor-pointer p-0 border-2 transition-colors ${
                        i === courante
                          ? "border-accent"
            ...
            <div className="p-6 flex flex-col min-h-0">
              ...
              <h3 className="m-0 mt-1 text-[21px] leading-snug">
                {produit.label}
              </h3>

              {produit.prix ? (
                <div className="mt-2 text-[15px] font-semibold text-accent-strong">
                  {produit.prix}
                </div>
              ) : null}

              <div className="mt-4 text-[13.8px] leading-relaxed text-muted overflow-y-auto flex-1">
                {produit.description ? (
