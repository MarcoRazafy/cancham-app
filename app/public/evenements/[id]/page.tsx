      ...
      <main className="max-w-[1120px] mx-auto px-5 py-10 w-full">
        ...
        {visuel ? (
          <Agrandir
            ...
            className="mb-8"
          >
            <div className="relative aspect-[16/9] md:aspect-[21/8] rounded-xl overflow-hidden border border-white/12">
              <Image
                src={visuel.url}
                alt={visuel.alt}
                fill
        ...
        */}
        <div className="grid gap-x-10 gap-y-7 lg:grid-cols-[minmax(0,1fr)_320px] items-start">
          <div className="lg:col-start-1 lg:row-start-1 min-w-0">
            ...
            <div className="flex gap-x-5 gap-y-2.5 flex-wrap text-[14px] text-white/75 mt-5">
          ...
          <aside className="lg:col-start-2 lg:row-start-1 lg:row-span-2 lg:sticky lg:top-6 rounded-xl border border-white/12 bg-white/[0.03] p-6">
            ...
            <p className="text-[12.5px] text-white/55 mt-3.5 mb-0">
              L’inscription est réservée aux membres à jour de cotisation.
            </p>

            <Link
              href="/public#adhesion"
              className="flex items-center justify-between gap-3 mt-4 pt-4 border-t border-white/10 text-[13px] text-[#3fc98a] font-semibold no-underline hover:underline"
            >
          ...
          <div className="lg:col-start-1 lg:row-start-2 min-w-0">
            ...
            {e.programme?.length ? (
              <div className="mt-10">
                <span className="surtitre text-white/45">Au programme</span>
                    ...
                    return (
                      <li key={i} className="flex gap-4">
                        <div className="flex flex-col items-center shrink-0 w-[72px]">
                          <span className="text-[13px] font-bold text-[#ff6b6b] whitespace-nowrap tabular-nums">
                            {etape.heure}
                          </span>
                          {derniere ? null : (
                        ...
                        <div className={`min-w-0 ${derniere ? "" : "pb-5"}`}>
                          ...
                          {etape.detail ? (
                            <p className="m-0 mt-1 text-[14px] text-white/65 leading-relaxed">
            ...
            {e.pourQui ? (
              <div className="mt-10 rounded-xl border border-white/10 bg-white/[0.03] px-5 py-4">
                <span className="surtitre text-white/45">Pour qui</span>
                <p className="m-0 mt-2 text-[15px] text-white/80 leading-relaxed">
        ...
        {autres.length ? (
          <section className="mt-14">
            <div className="overflow-hidden rounded-2xl border border-white/12 bg-[var(--marque-nuit-2)] p-5 md:p-8">
